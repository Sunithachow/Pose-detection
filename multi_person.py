...
MODEL_URL = "https://tfhub.dev/google/movenet/multipose/lightning/1"  # Verify this URL
...
def load_model():
    try:
        ...
        model_dir = model._handle_cache.resolve("module")
        if not os.path.exists(os.path.join(model_dir, "saved_model.pb")):
            raise ValueError("Model directory does not contain 'saved_model.pb'")
...
if __name__ == "__main__":
    ...
    if model:
        ...
        print("Failed to load the MoveNet model.")
